    ...
    <div class="max-w-2xl mx-auto w-full">
      <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8 max-h-[90vh] overflow-y-auto">
        <div class="text-center mb-6">
          <div
            class="w-16 h-16 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg"
          >
        ...
        <div v-if="qrSrc" class="mt-6 pt-4 border-t-2 border-gray-100">
          <div class="bg-gradient-to-br from-gray-50 to-white rounded-lg p-5">
            ...
            <div class="flex flex-col gap-2">
              <button @click="openSaveModal" class="w-full py-2.5 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg font-semibold hover:from-green-700 hover:to-green-800 transition-all transform hover:scale-[1.02] shadow-md text-sm">
                Save to Dashboard
              </button>
    ...
    <div v-if="saveModalVisible" class="fixed inset-0 backdrop-blur-sm flex items-center justify-center z-50 p-4" @click.self="saveModalVisible = false">
      <div class="bg-white rounded-xl max-w-sm w-full shadow-2xl animate-fade-in">
        ...
        <div class="flex gap-3 p-4 border-t border-gray-100">
          ...
          <button @click="saveToDashboard" class="flex-1 px-4 py-2 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg hover:from-green-700 hover:to-green-800 transition-all font-medium">
            Save
          </button>
        </div>
      </div>
