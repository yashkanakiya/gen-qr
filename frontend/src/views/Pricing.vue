  ...
  <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
      <div
        v-for="plan in plans"
        :key="plan.name"
        class="bg-white p-8 rounded-2xl shadow-md border border-gray-100 flex flex-col"
      >
        ...
        <button
          class="mt-8 w-full py-3 rounded-lg font-semibold"
          :class="plan.ctaClass"
    ...
    <p class="mt-12 text-center text-gray-400 text-sm">
      * All plans are currently in demo mode. No charges will be applied.
    </p>
  </div>
</template>
...
const plans = [
  ...
  },
  {
    ...
    features: [
      'Unlimited QR codes',
      'Advanced customization (logo, colors)',
      'Detailed analytics',
      'Bulk creation',
      'Priority support',
    ],
...
function handleCta(planName: any) {
  toast.add({
    severity: 'info',
    summary: `Selected ${planName}`,
    detail: 'This is a demo. No payment required.',
    life: 3000,
  })
}
</script>
